class SvgIcons {
  ...
  //   const DEFS_ELEMENT = document.createElementNS(
  //     'http://www.w3.org/2000/svg',
  //     'defs',
  //   );
  //   const LINEAR_GRADIENT_ELEMENT = document.createElementNS(
  //     'http://www.w3.org/2000/svg',
  //     'linearGradient',
  //   );
  ...
  //   const STOP_1_ELEMENT = document.createElementNS(
  //     'http://www.w3.org/2000/svg',
  //     'stop',
  //   );
  ...
  //   const STOP_2_ELEMENT = document.createElementNS(
  //     'http://www.w3.org/2000/svg',
  //     'stop',
  //   );
