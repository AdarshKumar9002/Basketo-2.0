class SvgIcons {
  ...
  likeIcon() {
    ...
    const likeIcon = this.svg(viewBox, className, path);
    return likeIcon;
  }
  ...
  compareIcon() {
    ...
    const compareIcon = this.svg(viewBox, className, path);
    return compareIcon;
  }
  ...
  shareIcon() {
    ...
    const shareIcon = this.svg(viewBox, className, path);
    return shareIcon;
  }
}
